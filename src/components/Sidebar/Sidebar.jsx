...
class Sidebar extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      restaurant: LocalStorageIO.getRestaurant()
    };
  }
        ...
        <div className="logo">
          ...
          >
            <div className="logo-img">
              <Image circle src={restaurant.iconUrl} alt="react-logo" />
            </div>
          </a>
          <a href="https://www.creative-tim.com" className="simple-text logo-normal">  {restaurant.title}</a>
          ...
          >
            ...
            <div class="logo-img">
              <Image src={this.state.restaurant.iconUrl} alt="fikifoo-logo" circle style={{ height: '70px', width: '70px' }} />
            </div>
            <a href="https://www.creative-tim.com" class="simple-text logo-normal">Creative Tim</a>
            <br />
            <Image src={Logo} alt="fikifoo-logo" style={{ marginLeft: '15%' }} />
        ...
        <div className="sidebar-wrapper" ref="sidebarWrapper">
          <div className="user">
            <div className="photo">
              ...
              <p className="name-avatar">{getInitials(user.name)}</p>
            </div>
            <div className="info">
              <a
                onClick={() =>
          ...
          <div>
          <Image src={Logo} alt="fikifoo-logo" style={{ padding: '3%', position: 'fixed', bottom: 0 }} />
        </div>
        </div>
      </div>
    );
